...
import CoustomRating from '@/components/itemrating/page';
    ...
    <div>
      ...
      <div className='h-auto bg-gray-200 w-full px-20 py-10'>
        <div className='flex h-auto w-full ' >
            ...
            <div className='flex'>
              ...
              <div className="bg-white w-[500px] h-auto px-2 space-y-4">
                ...
                <div className='flex items-center'>
                  ...
                  <button className='h-7 w-7 rounded mx-3 font-bold hover:bg-slate-400 hover:text-white bg-slate-300'>-</button>
          ...
          <div className="p-4 bg-gray-200 shadow-md text-xs space-y-4">
